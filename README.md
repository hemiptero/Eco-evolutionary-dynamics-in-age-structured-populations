...
## Overview
This repository contains the source code, simulation scripts, and mathematical derivations accompanying the manuscript: **"Highly adaptive traits trigger deterministic chaos: Eco-evolutionary dynamics in age-structured populations"** (submitted to *Ecology Letters*; under review).
...
## Citation
If you use this code or framework in your research, please cite the corresponding paper (currently under review):

**[Author name withheld for double-blind review]** (2026). *Highly adaptive traits trigger deterministic chaos: Eco-evolutionary dynamics in age-structured populations*. Ecology Letters (Submitted / Under Review).
